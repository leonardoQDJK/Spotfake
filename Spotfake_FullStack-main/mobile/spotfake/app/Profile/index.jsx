...
const Profile = () => {
    ...
    const getUserData = async () => {
        try {
            const response = await fetch("http://localhost:8081/usuarios/usuario", {
                method: 'POST',
                headers: {
    ...
    const changePass = async () => {
        try {
            const response = await fetch("http://localhost:8081/usuarios/mudar_senha", {
                method: "PUT",
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const updatePic = async () => {
        try {
            const response = await fetch("http://localhost:8081/usuarios/mudar_foto", {
                method: "PUT",
                headers: {
                    'Content-Type': 'application/json',
                },
